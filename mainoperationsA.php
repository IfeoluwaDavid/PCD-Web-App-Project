...
<head>
	<title>Home</title>
	<link rel="stylesheet" type="text/css" href="CSS/mainoperationsA.css">
</head>
<body>
	<div class="header">
	</div>
	...
	<ul>
	<h1>PartsCribber</h1>
	<li><a class="active" href="mainoperationsA.php">Item Check-Out</a></li>
	...
	<div id="rightcolumn">
	<form method="post" action="mainoperationsA.php">
	
		<div class="title">
		<h3>
		<?php echo "Main Operations - Student Authentication (1/3)"; ?>
		</h3>
		</div>
